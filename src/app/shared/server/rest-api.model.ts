...
export class UploadResourceType extends ResourceType {
  uploadFolder: UploadFolderRef;
  multiSelect: boolean;

  constructor(data: any) {
    super(data);
    readObject<UploadFolderRef>(this, data, 'uploadFolder', UploadFolderRef);
    readValue(this, data, 'multiSelect');
  }
...
/* DEPRECATED */
export class UploadFolder extends IdModel {
  name: string;
  description: string;
  isPublic: boolean;
  ...
  constructor(data: any) {
    ...
    readValue(this, data, 'description');
    readValue(this, data, 'isPublic');
    readArrayWithFn<string>(this, data, 'mimeTypes', (data) => data);
  }
...
export declare type UploadFolderList = Array<UploadFolder>;

/* DEPRECATED */
export class UploadFolderRef extends IdModel {
  name: string;
...
export class Upload extends IdModel {
  fileName: string;
  folderId: number;
  url: string;
  mimeType: string;
...
export declare type UploadList = Array<Upload>;
...
export class Education extends IdModel {
  type: string;
  title: string;
  content: string;
  questions: string;
  ...
  event: EventRef;
  educationType: EducationTypeRef;
  educationTheme: EducationThemeRef;
  ...
  constructor(data: any) {
    ...
    readValue(this, data, 'questions');
    readObject<Upload>(this, data, 'recording', Upload);

    readObject<EventRef>(this, data, 'event', EventRef);
    readObject<EducationTypeRef>(this, data, 'educationType', EducationTypeRef);
    readObject<EducationThemeRef>(this, data, 'educationTheme', EducationThemeRef);
  }
  ...
  updateObject(): Education {
    return new Education({ id: this.id, type: this.type });
  }
}

export declare type EducationList = Array<Education>;

export class EducationType extends IdModel {
  name: string;
  description: string;
  eventType: EventType;
  authorResourceType: UserResourceType;
  ...
  constructor(data: any) {
    ...
    readValue(this, data, 'name');
    readValue(this, data, 'description');
    readObject<EventType>(this, data, 'eventType', EventType);
    readObject<UserResourceType>(this, data, 'authorResourceType', UserResourceType);
    readObject<UploadFolder>(this, data, 'uploadFolder', UploadFolder);
  }
  ...
  asRef(): EducationTypeRef {
    return new EducationTypeRef(this.rawData);
  }
}

export declare type EducationTypeList = Array<EducationType>;

export class EducationTypeRef extends IdModel {
  name: string;
...
export class EducationTheme extends IdModel {
  title: string;
  content: string;
  ...
  constructor(data: any) {
    ...
    readValue(this, data, 'title');
    readValue(this, data, 'content');
    readObject<EducationType>(this, data, 'educationType', EducationType);
    readObject<Upload>(this, data, 'image', Upload);
  }
  ...
  asRef(): EducationThemeRef {
    return new EducationThemeRef(this.rawData);
  }
}

export declare type EducationThemeList = Array<EducationTheme>;

export class EducationThemeRef extends IdModel {
  title: string;
