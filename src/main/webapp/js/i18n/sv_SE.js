...
angular.module('myApp.translation_sv_SE', []).
    value('translationMap', {
        ...
        "navbar.label.educations" : "Undervisning",
        "navbar.label.educationThemes" : "Undervisningsteman",
        "navbar.label.educationTypes" : "Undervisningstyper",
        "navbar.label.eventTypes" : "Händelsetyper",
        "navbar.label.podcasts" : "Podcasts",
        "navbar.label.uploadFolders" : "Filkataloger",
        "navbar.label.userDetails" : "Användaruppgifter",
        "navbar.label.feedback" : "Synpunkter",
        ...
        "formLabel.event" : "Händelse",
        "formLabel.eventType" : "Händelsetyp",
        "formLabel.resourceType" : "Resurstyp",
        "formLabel.educationType" : "Undervisningstyp",
        "formLabel.educationTheme" : "Undervisningstema",
        "formLabel.authorName" : "Författare",
        "formLabel.copyright" : "Copyrights",
        "formLabel.image" : "Bild",
        "formLabel.audio" : "Ljud",
        ...
        "formLabel.questions" : "Samtalsfrågor",
        "formLabel.mainCategory" : "Huvudkategori",
        "formLabel.subCategory" : "Underkategori",
        "formLabel.language" : "Språk",
        "formLabel.link" : "Länk",
        "formLabel.podcastUrl" : "Podcastlänk",
        
        "modalLabel.user" : "Välj person",
        "modalLabel.group" : "Välj grupp",
        "modalLabel.location" : "Välj lokal",
        "modalLabel.image" : "Välj bild",
        "modalLabel.audio" : "Välj ljudfil",
        "modalLabel.uploadFolder": "Välj filkatalog",
        "modalLabel.userResource" : "Välj person",
        "modalLabel.uploadResource" : "Välj fil",
        "modalLabel.event" : "Välj händelse",
        "modalLabel.eventType" : "Välj händelsetyp",
        ...
        "educationThemeEditor.label.newTitle" : "Nytt undervisningstema",
        "educationThemeEditor.label.editTitle" : "Redigera undervisningstema",
        "educationThemeEditor.alert.itemWasCreated" : "Undervisningstemat skapades!",
        "educationThemeEditor.alert.itemWasUpdated" : "Undervisningstemat uppdaterades!",
        "educationTheme.educationType.mustBeSet" : "Undervisningsetyp måste anges",
        "educationTheme.title.notEmpty" : "Titel måste anges",
        "educationTheme.content.max10000Chars" : "Innehållet får max innehålla 10000 tecken.",
        "educationTheme.image.mustBeSet" : "En bild måste anges",

        "educationType" : "Undervisningstyp",
        "educationTypeItems.label.title" : "Undervisningstyper",
        "educationTypeItems.action.new" : "Ny undervisningstyp",
        "educationTypeItems.prompt.itemDeleteConfirmation" : "Vill du verkligen radera undervisningstypen?",
        "educationTypeItems.alert.itemWasDeleted" : "Undervisningstypen raderades!",

        "educationTypeItem.prompt.itemDeleteConfirmation" : "Vill du verkligen radera undervisningstypen?",
        "educationTypeItem.alert.itemWasDeleted" : "Undervisningstypen raderades!",
        "educationTypeItem.label.backToItems" : "« Tillbaka till undervisningstyper",

        "educationTypeEditor.label.newTitle" : "Ny undervisningstyp",
        "educationTypeEditor.label.editTitle" : "Redigera undervisningstyp",
        "educationTypeEditor.alert.itemWasCreated" : "Undervisningstypen skapades!",
        "educationTypeEditor.alert.itemWasUpdated" : "Undervisningstypen uppdaterades!",
        "educationType.eventType.mustBeSet" : "Händelsetyp måste anges",
        "educationType.authorResourceType.mustBeSet" : "Resurstyp måste anges för författare",
        "educationType.uploadFolder.mustBeSet" : "Filkatalog måste anges",

        "education" : "Undervisning",
        "educationItems.label.title" : "Undervisningar",
        "educationItems.action.new" : "Ny undervisning",
        "educationItems.prompt.itemDeleteConfirmation" : "Vill du verkligen radera undervisningen?",
        "educationItems.alert.itemWasDeleted" : "Undervisningen raderades!",

        "educationItem.prompt.itemDeleteConfirmation" : "Vill du verkligen radera undervisningen?",
        "educationItem.alert.itemWasDeleted" : "Undervisningen raderades!",
        "educationItem.label.backToItems" : "« Tillbaka till undervisningar",

        "educationEditor.label.newTitle" : "Ny undervisning",
        "educationEditor.label.editTitle" : "Redigera undervisning",
        "educationEditor.alert.itemWasCreated" : "Undervisningen skapades!",
        ...
        "podcast" : "Podcast",
        "podcastItems.label.title" : "Podcasts",
        "podcastItems.action.new" : "Ny podcast",
        "podcastItems.prompt.itemDeleteConfirmation" : "Vill du verkligen radera podcasten?",
        "podcastItems.alert.itemWasDeleted" : "Podcasten raderades!",

        "podcastItem.prompt.itemDeleteConfirmation" : "Vill du verkligen radera podcasten?",
        "podcastItem.alert.itemWasDeleted" : "Podcasten raderades!",
        "podcastItem.label.backToItems" : "« Tillbaka till podcasts",

        "podcastEditor.label.newTitle" : "Ny podcast",
        "podcastEditor.label.editTitle" : "Redigera podcast",
        "podcastEditor.alert.itemWasCreated" : "Podcasten skapades!",
        "podcastEditor.alert.itemWasUpdated" : "Podcasten uppdaterades!",
        "podcast.educationType.mustBeSet" : "Utbildningstyp måste anges",
        "podcast.image.mustBeSet" : "Bild måste anges",
        "podcast.title.notEmpty" : "Titel måste anges",
        "podcast.subTitle.notEmpty" : "Undertidel måste anges",
        "podcast.authorName.notEmpty" : "Författare måste anges",
        "podcast.copyright.notEmpty" : "Copyright måste anges",
        "podcast.description.max4000Chars" : "Beskrivningen får max innehålla 40000 tecken.",
        "podcast.mainCategory.notEmpty" : "Huvudkategori måste anges",
        "podcast.subCategory.notEmpty" : "Underkatagori måste anges",
        "podcast.language.notEmpty" : "Språk måste anges",
        "podcast.link.notEmpty" : "Länk måste anges",
