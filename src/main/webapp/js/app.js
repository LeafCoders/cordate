...
//        $routeProvider.when('/', {templateUrl:'partials/home.html', controller:HomeController});
        ...
        $routeProvider.when('/users/new', {templateUrl:'partials/userEditor.html', controller:UserEditorController, resolve:UserController.data});
        $routeProvider.when('/users/:id', {templateUrl:'partials/user.html', controller:UserController, resolve:UserController.data});
        $routeProvider.when('/users/:id/edit', {templateUrl:'partials/userEditor.html', controller:UserEditorController, resolve:UserController.data});

        $routeProvider.when('/groups', {templateUrl:'partials/groups.html', controller:GroupsController, resolve:GroupsController.data});
        $routeProvider.when('/groups/new', {templateUrl:'partials/groupEditor.html', controller:GroupEditorController, resolve:GroupController.data});
        $routeProvider.when('/groups/:id', {templateUrl:'partials/group.html', controller:GroupController, resolve:GroupController.data});
        $routeProvider.when('/groups/:id/edit', {templateUrl:'partials/groupEditor.html', controller:GroupEditorController, resolve:GroupController.data});
        ...
        $routeProvider.when('/groupMemberships/new', {templateUrl:'partials/groupMembershipEditor.html', controller:GroupMembershipEditorController, resolve:GroupMembershipController.data});
        ...
        $routeProvider.when('/groupMemberships/:id/edit', {templateUrl:'partials/groupMembershipEditor.html', controller:GroupMembershipEditorController, resolve:GroupMembershipController.data});
        ...
        $routeProvider.when('/permissions/new', {templateUrl:'partials/permissionEditor.html', controller:PermissionEditorController, resolve:PermissionController.data});
        ...
        $routeProvider.when('/permissions/:id/edit', {templateUrl:'partials/permissionEditor.html', controller:PermissionEditorController, resolve:PermissionController.data});
        ...
        $routeProvider.when('/events/new', {templateUrl:'partials/eventEditor.html', controller:EventEditorController, resolve:EventController.data});
        $routeProvider.when('/events/:id', {templateUrl:'partials/event.html', controller:EventController, resolve:EventController.data});
        $routeProvider.when('/events/:id/edit', {templateUrl:'partials/eventEditor.html', controller:EventEditorController, resolve:EventController.data});
