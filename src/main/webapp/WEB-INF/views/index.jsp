        ...
        <div class="navbar navbar-default navbar-static-top" role="navigation">
            <div class="container">
                ...
                <ul class="main-menu nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a permission="view:locations,view:resourceTypes,view:eventTypes,view:signupUsers,view:users,view:groups,view:groupMemberships,view:permissions"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li permission="view:signupUsers,view:users,view:groups,view:groupMemberships,view:permissions" class="divider visible-xs"></li>
